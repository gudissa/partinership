...
const Requests = () => {
  const [requests, setRequests] = useState([
    {
      ...
      pdf: "/sample.pdf",
      date: "2023-10-01",
      details: "Need approval for project documentation",
      status: "pending",
      comments: [],
    },
    {
  ...
  const handleDeleteRequest = (id) => setRequests(prev => prev.filter(item => item.id !== id));
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen w-full">
      <h1 className="text-2xl font-bold text-gray-800 mb-6">Document Requests</h1>
          ...
          <tbody className="divide-y divide-gray-200">
            {currentRequests.map((item) => (
              ...
              >
                ...
                <td className="px-4 py-4 text-sm text-gray-800">{item.email}</td>
